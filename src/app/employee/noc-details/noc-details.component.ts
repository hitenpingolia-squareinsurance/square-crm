...
@Component({
  ...
  styleUrls: ['./noc-details.component.css']
})
export class NocDetailsComponent implements OnInit {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        that.http
          .post<DataTablesResponse>(
            ...
            "/b-crm/EmployeeResign/ViewNoc?User_Id=" +
  ...
  DeleteRequest(DeleteId: any, TableName: any) {
    ...
    if (confirms == true) {
      ...
      this.api.IsLoading();
      this.api.HttpPostType("b-crm/EmployeeResign/DeleteData", formData).then(
        (result: any) => {
  ...
  ActiveInactiveVarSt(ys: any) {
    this.SetIdvalue = ys;
    alert(this.SetIdvalue);
  }
  //ACCEPT REQUEST
  ...
  ActiveInactive() {
    ...
    if (confirms == true) {
      ...
      formData.append("Id", this.SetIdvalue);
      formData.append("TableName", 'employeeresigndetails');
      // formData.append("Status", Status);
      formData.append("selectedNoc", this.selectedNoc);
      ...
      this.api.IsLoading();
      this.api
        .HttpPostType("b-crm/EmployeeResign/UpdateActiveInactive", formData)
        .then(
          (result: any) => {
            this.api.HideLoading();
            // console.log(result);
