...
@Component({
  selector: "app-agent-renewal-filter",
  templateUrl: "./agent-renewal-filter.component.html",
  styleUrls: ["./agent-renewal-filter.component.css"],
})
export class AgentRenewalFilterComponent implements OnInit {
  post: Post;
  ...
  ngOnInit() {
    ...
    if (
      ...
      this.urlSegmentSub == "renewals" || this.urlSegmentSub == "renewals-section"||
