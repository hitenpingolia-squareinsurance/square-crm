...
export class SalaryReportComponent implements OnInit {
    ...
    for (let i = 0; i < this.dataAr.length; i++) {
      ...
      await this.http
        ...
        .then((res: any) => {
          ...
          this.dataAr[i]["ProfileTotalTargetStr"] = data.ProfileTotalTargetStr;
          ...
          this.dataAr[i]["AllocatedTeamBusiness"] = data.AllocatedTeamBusiness;
          ...
          this.dataAr[i]["AllocatedSelfBusiness"] = data.AllocatedSelfBusiness;
  ...
  //===== UPLOAD FINAL SALARY =====//
  UpdateSalaryDetails(): void {
    const dialogRef = this.dialog.open(UpdateSalaryDetailsComponent, {
      width: "25%",
      height: "45%",
      disableClose: true,
      data: {},
