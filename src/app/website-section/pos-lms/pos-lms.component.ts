...
@Component({
  selector: 'app-pos-lms',
  templateUrl: './pos-lms.component.html',
  styleUrls: ['./pos-lms.component.css']
})
export class PosLmsComponent implements OnInit {
        ...
        that.http
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(environment.apiUrl +
              "/WebsiteSection/PospLeads?User_Id=" +
