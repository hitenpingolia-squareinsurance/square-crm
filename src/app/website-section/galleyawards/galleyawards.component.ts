...
@Component({
  selector: "app-galleyawards",
  templateUrl: "./galleyawards.component.html",
  styleUrls: ["./galleyawards.component.css"],
})
export class GalleyawardsComponent implements OnInit {
        ...
        that.http
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(environment.apiUrl +
              "/WebsiteSection/FetchGalleryData?User_Id=" +
  ...
  AddPosterWebsite() {
    const dialogRef = this.dialog.open(AddMoreComponent, {
      width: "50%",
      height: "50%",
      disableClose: true,
    });
