...
@Component({
  selector: "app-product-image-dynamic",
  templateUrl: "./product-image-dynamic.component.html",
  styleUrls: ["./product-image-dynamic.component.css"],
})
export class ProductImageDynamicComponent implements OnInit {
        ...
        that.http
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(environment.apiUrl +
              "/WebsiteSection/ViewProductDynamicImage?User_Id=" +
