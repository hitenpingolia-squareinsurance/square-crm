...
@Component({
  selector: "app-dynamic-quote-view",
  templateUrl: "./dynamic-quote-view.component.html",
  styleUrls: ["./dynamic-quote-view.component.css"],
})
export class DynamicQuoteViewComponent implements OnInit {
        ...
        that.http
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(environment.apiUrl +
              "/WebsiteSection/ViewProductQuotes?User_Id=" +
  ...
  AddProductQuotes(type: any, id: any) {
    const dialogRef = this.dialog.open(AddQuotesComponent, {
      width: "50%",
      height: "80%",
      disableClose: true,
