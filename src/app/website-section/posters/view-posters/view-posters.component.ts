...
import { AddPostersComponent } from "./../add-posters/add-posters.component";
...
@Component({
  selector: "app-view-posters",
  templateUrl: "./view-posters.component.html",
  styleUrls: ["./view-posters.component.css"],
})
export class ViewPostersComponent implements OnInit {
        ...
        that.http
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(environment.apiUrl +
              "/WebsiteSection/ViewDataPoster?User_Id=" +
  ...
  AddPosterWebsite(type: any, id: any) {
    const dialogRef = this.dialog.open(AddPostersComponent, {
      width: "70%",
      height: "70%",
      disableClose: true,
  ...
  //     this.api.IsLoading();
  //     this.api.HttpPostType('WebsiteSection/DeletePoster', formData).then((result:any) => {
