...
export class PayoutPostingComponent implements OnInit {
  ...
  constructor(
    ...
    // this.SRLOB_Ar = [{Id:'Motor',Name:'Motor'},{Id:'Health',Name:'Health'},{Id:'Non Motor',Name:'Non Motor'}];
    this.SRSource_Ar = [
      { Id: "BMS", Name: "Offline" },
      { Id: "Web", Name: "Online" },
      { Id: "Excel", Name: "Excel" },
        ...
        that.http
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(
              environment.apiUrl +
                "/reports/PayoutPosting/GridData?User_Id=" +
                this.api.GetUserData("Id") +
                "&User_Code=" +
                this.api.GetUserData("Code") +
                "&User_Type=" +
  ...
  EditPayout(row_Id, Index): void {
    ...
    dialogRef.afterClosed().subscribe((result: any) => {
      // console.log(result);
      //alert(result['SR_Id']);
      //alert(result['UpdateIndex']);
      //alert(result['Payout_Update_Columns']['Web_Agent_Payout_OD']);
