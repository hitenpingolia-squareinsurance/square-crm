...
@Component({
  ...
  templateUrl: "./payin-payout.component.html",
  styleUrls: ["./payin-payout.component.css"],
})
export class PayinPayoutComponent implements OnInit {
        ...
        that.http
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(
              environment.apiUrl +
                "/reports/PayIn/GridData?Type=All&User_Id=" +
                this.api.GetUserData("Id") +
                "&User_Code=" +
                this.api.GetUserData("Code") +
                "&User_Type=" +
