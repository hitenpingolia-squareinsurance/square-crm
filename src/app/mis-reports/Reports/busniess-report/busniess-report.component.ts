...
@Component({
  selector: "app-busniess-report",
  templateUrl: "./busniess-report.component.html",
  styleUrls: ["./busniess-report.component.css"],
})
export class BusniessReportComponent implements OnInit {
  ...
  datatableFunction() {
    ...
    urls = "/b-crm/Mongo/policydatafetchMongo";
