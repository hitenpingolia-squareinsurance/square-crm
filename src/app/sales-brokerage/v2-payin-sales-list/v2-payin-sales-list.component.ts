...
@Component({
  selector: "app-v2-payin-sales-list",
  templateUrl: "./v2-payin-sales-list.component.html",
  styleUrls: ["./v2-payin-sales-list.component.css"],
})
export class V2PayinSalesListComponent implements OnInit {
  ...
  dropdownSettings_removeSelectAll: any = {};
  cities: any = [];
  selectedItems: any = [];
  ...
  constructor(
    ...
    this.dropdownSettings_removeSelectAll = {
      allowSearchFilter: true,
      singleSelection: false,
      enableCheckAll: false,
      idField: "Id",
  ...
  ngOnInit() {
    this.PayInForm = this.fb.group({
      Bussiness_Month: ["", [Validators.required]],
      ...
      .then(
        (result) => {
          ...
          if (result["Status"] == true) {
            this.BusinessMonths_Ar = result["Data"]["Bussiness_Months"];

            this.PayInForm.get("Bussiness_Month").setValue(
              result["Data"]["CurrentMonth"]
            );
  ...
  LOB(Type: any) {
    var States_IdsControl = this.PayInForm.get("States_Ids");

    var SubProduct_IdsControl = this.PayInForm.get("SubProduct_Ids");
    var Class_IdsControl = this.PayInForm.get("Class_Ids");
    var Sub_Class_IdsControl = this.PayInForm.get("Sub_Class_Ids");

    if (this.PayInForm.value["LOB"] == "Motor") {
      States_IdsControl.setValidators([Validators.required]);
      SubProduct_IdsControl.setValidators([Validators.required]);
      Class_IdsControl.setValidators([Validators.required]);
      Sub_Class_IdsControl.setValidators([Validators.required]);
    } else {
      States_IdsControl.setValidators(null);
      SubProduct_IdsControl.setValidators(null);
      Class_IdsControl.setValidators(null);
      Sub_Class_IdsControl.setValidators(null);
    }
    States_IdsControl.updateValueAndValidity();

    SubProduct_IdsControl.updateValueAndValidity();
    Class_IdsControl.updateValueAndValidity();
    Sub_Class_IdsControl.updateValueAndValidity();
  ...
  SearchBtn() {
    ...
    if (this.PayInForm.invalid) {
      ...
      var query = {
        Bussiness_Month: fields["Bussiness_Month"],
        LOB: fields["LOB"],
          ...
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(
              environment.apiUrlBms +
                "/../../v3/pay-in/WebPayIn/GridData?User_Id=" +
                this.api.GetUserId()
            ),
  ...
  AddPayIn(Id, Type) {
    const dialogRef = this.dialog.open(V2PayInRequestUpdateComponent, {
      ...
      data: {
        Id: Id,
        Type: Type,
        Bussiness_Month: this.PayInForm.value["Bussiness_Month"],
      },
    });
