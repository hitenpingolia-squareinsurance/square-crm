...
@Component({
  selector: "app-pa-group-sr",
  templateUrl: "./pa-group-sr.component.html",
  styleUrls: ["./pa-group-sr.component.css"],
})
export class PaGroupSrComponent implements OnInit {
  ...
  ViewGroupSrMembers(row_Id: any): void {
    const dialogRef = this.dialog.open(GroupSrInsuredComponent, {
      width: "75%",
      height: "75%",
      data: { Id: row_Id, url_segment: "group-pa" },
    });
