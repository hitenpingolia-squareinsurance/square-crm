...
@Component({
  selector: "app-health-group-sr",
  templateUrl: "./health-group-sr.component.html",
  styleUrls: ["./health-group-sr.component.css"],
})
export class HealthGroupSrComponent implements OnInit {
          ...
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(
              environment.apiUrlBms +
                "/GroupSrRelated/GetGroupSrData?ActivePage=" +
                this.ActivePage +
                "&User_Id=" +
                this.api.GetUserData("Id") +
                "&User_Code=" +
  ...
  ViewGroupSrMembers(row_Id: any): void {
    const dialogRef = this.dialog.open(GroupSrInsuredComponent, {
      width: "75%",
      height: "75%",
      data: { Id: row_Id, url_segment: "group-health" },
    });
  ...
  ViewEndorsementLog(row_Id: any): void {
    const dialogRef = this.dialog.open(GroupSrEndorsementTrackComponent, {
      width: "65%",
      height: "75%",
      data: { Id: row_Id, url_segment: "group-health" },
    });
