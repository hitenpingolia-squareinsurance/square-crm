...
@Component({
  selector: "app-lost-renewal-manager-old",
  templateUrl: "./lost-renewal-manager-old.component.html",
  styleUrls: ["./lost-renewal-manager-old.component.css"],
})
export class LostRenewalManagerOldComponent implements OnInit {
