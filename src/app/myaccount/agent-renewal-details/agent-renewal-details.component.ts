...
// import "../../../stylesNew.css"; // Import your custom styles
...
type NewType = AgentRenewalDetailsComponent;

@Component({
  selector: "app-agent-renewal-details",
  styleUrls: ["./agent-renewal-details.component.css"],
  templateUrl: "./agent-renewal-details.component.html",
  changeDetection: ChangeDetectionStrategy.Default,
})
export class AgentRenewalDetailsComponent implements OnInit {
