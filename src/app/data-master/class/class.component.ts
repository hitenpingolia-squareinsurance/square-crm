...
export class ClassComponent implements OnInit {
        ...
        that.http
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(
              environment.apiUrl + "/data/ClassController/GridData"
            ),
  ...
  async Update(Id, Status) {
    ...
    if (willDelete) {
      ...
      this.api
        .HttpGetType(
          "data/ClassController/UpdateStatusById?Id=" + Id + "&Status=" + Status
        )
        .then(
          (result) => {
  ...
  async Is_Delete(Id) {
    ...
    if (willDelete) {
      ...
      this.api.IsLoading();
      this.api.HttpGetType("data/ClassController/DeleteById?Id=" + Id).then(
        (result) => {
          this.api.HideLoading();
