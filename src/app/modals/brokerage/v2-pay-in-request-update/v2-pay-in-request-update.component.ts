...
export class V2PayInRequestUpdateComponent implements OnInit {
  ...
  onChangeRMA(Agent_Id, PayInGroupFields, SelectionType) {
    ...
    formData.append("Product_Ids", this.rowAr.Product_Ids);
  ...
  ComponentsData() {
    ...
    this.api
      .Call(
        "../v2/pay-in/WebPayIn/GetPayInRow?User_Id=" +
          this.api.GetUserId() +
          "&User_Role=" +
  ...
  AddPayIn() {
    ...
    if (this.PayInForm.invalid) {
      ...
      var url = "../v2/pay-in/WebPayIn/AddRequest";
      if (this.ViewType == "ViewRequest") {
        url = "../v2/pay-in/WebPayIn/UpdatePayoutRequest";
      }
