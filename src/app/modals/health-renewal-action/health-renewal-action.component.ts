...
@Component({
  selector: "app-health-renewal-action",
  templateUrl: "./health-renewal-action.component.html",
  styleUrls: ["./health-renewal-action.component.css"],
})
export class HealthRenewalActionComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<HealthRenewalActionComponent>,
    ...
    this.ActionForm = this.formBuilder.group({
      ...
      Payment_Reciept: ["", Validators.required],
  ...
  GetSR() {
    ...
    formData.append("Lob_Name", "Health");
    formData.append("User_Id", this.api.GetUserData("Id"));
    formData.append("User_Code", this.api.GetUserData("Code"));

    this.api.IsLoading();
    this.api
      .HttpForSR("post", "Submit/GetSrHealthStatusDetails", formData)
      .then(
        (result) => {
  ...
  SubmitActionForm() {
    ...
    this.api.IsLoading();
    this.api
      .HttpForSR("post", "HealthRenewal/UpdateRenewalDetails", formData)
      .then(
        (result) => {
          this.api.HideLoading();
