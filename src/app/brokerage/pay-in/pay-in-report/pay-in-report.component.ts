...
@Component({
  selector: "app-pay-in-report",
  templateUrl: "./pay-in-report.component.html",
  styleUrls: ["./pay-in-report.component.css"],
})
export class PayInReportComponent implements OnInit {
          ...
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(
              environment.apiUrlBmsBase +
                "/../v2/pay-in/PayIn/GridData?User_Id=" +
                this.api.GetUserId() +
                "&source=crm"
            ),
  ...
  AddPayIn(Id, Type) {
    const dialogRef = this.dialog.open(PayinformmodelComponent, {
      width: "98%",
      height: "95%",
      disableClose: true,
  ...
  DeleteRMAuthority(Id) {
    ...
    if (r == true) {
      ...
      this.api
        .Call(
          "../v2/pay-in/PayIn/DeleteRMAuthority?Id=" +
            Id +
            "&User_Id=" +
            this.api.GetUserId()
        )
  ...
  DisableRMAuthority(Id) {
    ...
    if (r == true) {
      ...
      this.api
        .Call(
          "../v2/pay-in/PayIn/DisableRMAuthority?Id=" +
            Id +
            "&User_Id=" +
            this.api.GetUserId()
        )
