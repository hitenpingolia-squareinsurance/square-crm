...
@Component({
  selector: "app-generate-invoice-new",
  templateUrl: "./generate-invoice-new.component.html",
  styleUrls: ["./generate-invoice-new.component.css"],
})
export class GenerateInvoiceNewComponent implements OnInit {
          ...
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(
              environment.apiUrlBmsBase +
                "../../v2/reports/Invoicing/GridData2?Payout_Mode=" +
                this.Payout_Mode +
                "&ActiveTab=" +
                this.TabsType +
                "&User_Id=" +
