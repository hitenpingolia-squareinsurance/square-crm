...
@Component({
  selector: "app-all-payout-requests",
  templateUrl: "./all-payout-requests.component.html",
  styleUrls: ["./all-payout-requests.component.css"],
})
export class AllPayoutRequestsComponent implements OnInit {
  ...
  constructor(
    ...
    } else if (this.router.url == "/rm/payout/partner-earning") {
      this.RequestType = "RM";
    } else {
          ...
          .post<DataTablesResponse>(
            this.api.additionParmsEnc(
              environment.apiUrlBmsBase +
                "/brokerage/PayoutRequest/GridData_All_PO_Requests?Payout_Mode=" +
                this.Payout_Mode +
                "&ActiveTab=" +
                this.TabsType +
                "&User_Id=" +
