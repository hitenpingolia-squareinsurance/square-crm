...
@Component({
  selector: "app-recovery-files",
  templateUrl: "./recovery-files.component.html",
  styleUrls: ["./recovery-files.component.css"],
})
export class RecoveryFilesComponent implements OnInit {
  ...
  async Upload() {
    ...
    if (Is_Confirm) {
      ...
      this.api.IsLoading();
      this.api
        .HttpPostType("bulk-upload/ImportData/ImportActionRecovery", formData)
        .then(
          (result) => {
