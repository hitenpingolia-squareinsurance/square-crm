...
@Component({
  selector: "app-club-manager-reports",
  templateUrl: "./club-manager-reports.component.html",
  styleUrls: ["./club-manager-reports.component.css"],
})
export class ClubManagerReportsComponent implements OnInit {
  ...
  SetActiveTab(tab_value: any) {
    ...
    this.api.SetActiveTabModuleWise(tab_value, "dsr-manager-reports");
