...
import { ViewQcReportComponent } from "./view-qc-report/view-qc-report.component";
...
@Component({
  ...
  styleUrls: ["./qc-report.component.css"],
})
export class QcReportComponent implements OnInit {
  ...
  Upload() {
    ...
    this.api
      .HttpPostType("../v3/sr/OfflineBookingExcelUpload/Upload", formData)
      .then(
        (result) => {
          if (this.type != "agent") {
