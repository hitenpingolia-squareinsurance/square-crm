...
@Component({
  selector: "app-agent-retention",
  templateUrl: "./agent-retention.component.html",
  styleUrls: ["./agent-retention.component.css"],
})
export class AgentRetentionComponent implements OnInit {
  LeadSrData: any;
  ...
  FilterData() {
    ...
    if (fields["Year"] != "") {
      this.api.IsLoading();
      this.api.HttpPostType("Managementreports/AgentRetantion", formData).then(
        (result: any) => {
